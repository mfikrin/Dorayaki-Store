    ...
    <body>
        ...
        <div class="box split-screen">
            <div class="left-box left-box-signin">
                <section class="copy">
                    <h1 class="main-title signin">Form Forgot Passwords</h1>
                    ...
                    <form class="fill-form" >
                        <ul>
                            <li>
                                <input class="input-text" type="text" id="usernameEmail" name="usernameEmail" placeholder="Please input your Username" required>
                            </li>
                            
                            <li>
                                <button class="submit btn" type="button" id="submit-btn" name="login">Reset Password</button>
                            </li>
                            <li>
        ...
        <script>
            ...
            form.submit.addEventListener('click', () => {
                ...
                const requestData = `usernameEmail=${form.usernameEmail.value}`;
                // console.log(requestData);

                request.open('post', '../util/forgotfunctions.php');
